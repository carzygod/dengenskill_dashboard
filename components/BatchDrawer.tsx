  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className="fixed right-3 top-1/2 z-50 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-[#00FF94] text-black shadow-lg shadow-[#00FF94]/40 transition hover:bg-[#00CC76]"
