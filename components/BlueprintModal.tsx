        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
            {activeTab === 'DOCS' ? (
                ...
                <div className="flex flex-col h-full gap-6">
                    ...
                    <div className="flex justify-between items-center bg-white/5 p-4 rounded-lg border border-white/5">
                         {[
                             ...
                             <div key={step.id} className={`flex items-center gap-3 ${
                                 buildStep >= step.id ? 'text-[#FF00FF] opacity-100' : 'text-gray-600 opacity-50'
                             }`}>
                                 <div className={`w-8 h-8 rounded-full flex items-center justify-center border ${
                                     buildStep >= step.id ? 'border-[#FF00FF] bg-[#FF00FF]/10' : 'border-gray-700'
                                 }`}>
                    ...
                    {buildStep === 4 && (
                        <button className="w-full py-4 bg-[#00FF94] text-black font-bold font-mono rounded hover:bg-[#00CC76] transition-all flex items-center justify-center gap-2">
