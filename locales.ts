...
export const TRANSLATIONS = {
  ...
  'zh-CN': {
    ...
    settings: {
      title: "系统配置",
      api_label: "OPENAI API 密钥",
      api_placeholder: "输入 ChatGPT 兼容的 API 密钥...",
      api_desc: "留空将使用默认密钥。所有配置会保存在本地浏览器（localhost）。",
      base_url_label: "OPENAI 基础地址",
      base_url_placeholder: "https://api.openai.com/v1/",
      base_url_desc: "当使用代理或私有部署时覆盖默认地址。",
      model_label: "模型",
      model_placeholder: "例如 gpt-5.2-ca",
      model_desc: "选择用于生成的 ChatGPT 兼容模型。",
      persist_note: "语言与 API 设置会在本地（localhost）持久化存储。",
      save: "保存配置",
      cancel: "取消"
    },
    terminal: {
  ...
  'zh-TW': {
    ...
    settings: {
      title: "系統配置",
      api_label: "OPENAI API 金鑰",
      api_placeholder: "輸入 ChatGPT 相容的 API 金鑰...",
      api_desc: "留空時使用預設金鑰。所有設定會儲存在本地瀏覽器（localhost）。",
      base_url_label: "OPENAI 基礎網址",
      base_url_placeholder: "https://api.openai.com/v1/",
      base_url_desc: "當使用代理或內部部署時可覆蓋預設 URL。",
      model_label: "模型",
      model_placeholder: "例如 gpt-5.2-ca",
      model_desc: "選擇要調用的 ChatGPT 相容模型。",
      persist_note: "語言與 API 設定會在本機（localhost）進行持久儲存。",
      save: "保存配置",
      cancel: "取消"
    },
    terminal: {
  ...
  'ru': {
    ...
    settings: {
      ...
      api_label: "OPENAI API КЛЮЧ",
      api_placeholder: "Введите ChatGPT-совместимый API ключ...",
      api_desc: "Оставьте пустым, чтобы использовать ключ по умолчанию. Все настройки сохраняются локально (localhost).",
      base_url_label: "OPENAI BASE URL",
      base_url_placeholder: "https://api.openai.com/v1/",
      base_url_desc: "Замените базовый адрес при использовании прокси или приватных хостов.",
      model_label: "Модель",
      model_placeholder: "например, gpt-5.2-ca",
      model_desc: "Выберите модель, совместимую с ChatGPT, для генерации.",
      persist_note: "Настройки языка и API сохраняются в localStorage для этого хоста.",
      save: "СОХРАНИТЬ",
      cancel: "ОТМЕНА"
    },
    terminal: {
